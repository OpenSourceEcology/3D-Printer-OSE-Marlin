...
#define STRING_CONFIG_H_AUTHOR "Marcin Jakubowski" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OSE D3D Printer"
...
#define X_MIN_ENDSTOP_INVERTING true // changed it to true - MJ
...
/**
   Default Ateps Per Unit (steps/mm)
   Override with M92
                                        X, Y, Z, E0 [, E1[, E2[, E3]]]
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 161.3 }
...
//Fuzzy definitions. Still it's not clear whether + or - applies. It should always be too high - as
//then the nozzle is not scratching the surface. Trial and error here unless a specific definition is given for + or -, which is
//unknown from this description and depends on how the code executes the correction.
